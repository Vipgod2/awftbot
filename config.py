...
APP_ID = int(os.environ.get("APP_ID", "29804031"))

#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "07d742a864b1f485e812311b009a29e1")
...
TUT_VID = os.environ.get("TUT_VID","https://t.me/MediasAdholokam/5")
...
#start message
START_MSG = os.environ.get("START_MESSAGE", "<b>ʜᴇʟʟᴏ {first}\n\n ɪ ᴀᴍ ᴛᴏᴋᴇɴ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ ғɪʟᴇ sᴛᴏʀᴇ ʙᴏᴛ , ɪ ᴄᴀɴ sᴛᴏʀᴇ ᴘʀɪᴠᴀᴛᴇ ғɪʟᴇs ɪɴ sᴘᴇᴄɪғɪᴇᴅ ᴄʜᴀɴɴᴇʟ ᴀɴᴅ ᴏᴛʜᴇʀ ᴜsᴇʀs ᴄᴀɴ ᴀᴄᴄᴇss ɪᴛ ғʀᴏᴍ sᴘᴇᴄɪᴀʟ ʟɪɴᴋ » @MediasAdholokam</b>")
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1480923991 5069922547").split()):
        ADMINS.append(int(x))
except ValueError:
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>» ʙʏ @MediasAdholokam</b>")
